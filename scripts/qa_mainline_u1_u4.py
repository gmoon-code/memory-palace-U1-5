...
for uid in ('unit-6','unit-7','unit-8'):
    if units.get(uid,{}).get('status')=='STUDENT_READY': problems.append(f'{uid} was released prematurely')
...
if not any(v in main for v in ['v2-apbio-0.22.0-u4-f6','v2-apbio-0.23.0-u5-f5','v2-apbio-0.24.0-u5-f6']): problems.append('runtime no longer includes a valid U4-F6-or-later version')
